// 맵 Map()
// 키와 값으로 이루어져 있다.
// 맵의 프로퍼티는 문자열뿐만 아니라 모든자료형을 사용할 수 있다.
// 맵의 프로퍼티는 순서대로 접근하고 처리할 수 있다.
let bag = new Map(); // Map객체의 인스턴스인 bag 생성.
console.log(bag.set("색상","빨강"));

// Map 객체를 만들면서 프러퍼티를 지정할 수 있다.
// [] 대괄호를 사용하면 처름부터 프로퍼티 지정할 수 있다.
let myCup = new Map([
    ["색상", "흰색"],
    ["재료","세라믹"],
    ["용량","450ml"]
...
numSet1.add(`three`).add("four").add("five");
console.log(numSet1);
...
let numSet3 = new Set([1,2,3,4,5,6,7,4,3,2,1,5,4,3,2,3,1,3,2,1,2,3,4,5,2,2,3,1]);
