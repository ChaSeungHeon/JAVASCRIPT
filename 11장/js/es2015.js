...
// 위 코드에서 객체 정의할 ㄸ 변수와 프로퍼티 이름이 같다면
// 줄여서 사용 가능하다.
...
// 심벌키에 접근
// [] (대괄호) 사용하여 프로퍼티나 메서드에 접근.
// 메서드 []()
console.log("member[id] : ", member[id]);
// console.log("member[tel]() : ", member[tel]())

// 심벌은 만들때마다 유일한 값을 가진다.
// 상황에 따라 만든 심벌을 다른 곳에서 사용해야할 경우
// 여러 곳에서 같이 사용할 수있는 심벌을 전역 심벌 이라고 한다.
// Symbol.for() 메서드
